...
Out of all the repeats, we select one 'official' repeat for visualization and testing.
...
if (create_models) {
  ...
  weighted_kTSP_RF_models_list <- purrr::map(weighted_kTSP_RF_models_list,
                                             function(x) setNames(x, stringr::str_c(names(x), "_weighted")))
  ...
  unweighted_kTSP_RF_models_list <- purrr::map(unweighted_kTSP_RF_models_list,
                                               function(x) setNames(x, stringr::str_c(names(x), "_unweighted")))
  ...
  for (model_index in 1:length(baseline_models_list)) {
    ...
    if (model_index == official_model) {
      ...
      baseline_models_list[["official_model"]] <- TRUE
      
    } else {
      
      baseline_models_list[["official_model"]] <- FALSE
