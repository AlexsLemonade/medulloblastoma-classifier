...
results_df <- results_list |> 
  ...
  dplyr::mutate(
    prop_observed = as.numeric(stringr::word(run, 2, sep = "_")),
...
It doesn't seem like filtering more cells out improves things for the Smart-seq2 dataset.
...
For the Smart-seq2 dataset, let's use values that represent _filtering > 0_ (at least one gene is observed), since it doesn't seem to matter very much.
...
We'll display filter > 0 for the 10X dataset as a matter of comparison as well.
