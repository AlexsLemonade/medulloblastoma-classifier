...
medulloPackage also fails to run because the pre-defined set of gene pairs used in `medulloPackage::classify()` (accessed via `library(medulloPackage); get(utils::data("bestFeaturesNew"))`) does not overlap with gene pairs available in the targeted gene set used in this experiment.
