...
# effect size can't handle when all the paired values have a difference of 0
...
accuracy_wilcox_test_df |>
  ...
  dplyr::filter(p < 0.05) |>
  dplyr::arrange(dplyr::desc(effsize)) |>
  knitr::kable()
...
targeted_dots_df <- compare_metrics_plot_df |>
  ...
  dplyr::mutate(perm_pvalue = 1 - dplyr::percent_rank(value),
