...
# Test for differences for each model type-measure pair
stats_df <- malignant_cell_qc_df |>
  dplyr::group_by(model_type, measure) |>
  rstatix::wilcox_test(value ~ classification,
                       p.adjust.method = "bonferroni")

# Add effect size information
effect_size_df <- malignant_cell_qc_df |>
  dplyr::group_by(model_type, measure) |>
  rstatix::wilcox_effsize(value ~ classification)
stats_df <- stats_df |>
  dplyr::inner_join(effect_size_df)
