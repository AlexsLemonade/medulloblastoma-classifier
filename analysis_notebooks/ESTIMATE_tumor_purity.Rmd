...
- ESTIMATE generates Stromal and Immune scores using ssGSEA, regardless of platform: $Stromal + Immune scores = ESTIMATE score$
...
- To return tumor purity scores, we must set platform = "affymetrix" (default) even though some data are RNA-seq, otherwise the TP conversion is not done
