...
- **Main point: the unweighted kTSP model performed best across both Array and RNA-seq data types**
- Median model performance is higher for Array test data compared to RNA-seq test data for kTSP models (unweighted and weighted) and medulloPackage
- Median model performance is similar Array and RNA-seq test data for LASSO, MM2S, and RF models
...
- For RNA-seq data, the model rankings from lowest median Kappa to highest: medullopackage, MM2S, LASSO, RF (unw), kTSP (w), RF (w), kTSP (unw)
...
baseline_kappa_plot <- plot_df |>
  ...
  ggplot2::geom_point(shape = 16,
                      position = ggplot2::position_jitterdodge(jitter.width = 0.1,
                                                               jitter.height = 0)) +
  ggplot2::coord_cartesian(xlim = c(0.8,1)) +
